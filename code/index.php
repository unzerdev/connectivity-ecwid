...
if(isset($ecwidResponse['store_id']) && !empty($ecwidResponse['store_id'])){
    ...
    $qForGetStoreDetails = mysqli_query($conn, "SELECT u_publicKey,u_privateKey,u_authStatus,u_captureStatus,u_chargeStatus  FROM configurations WHERE e_storeId = '".$eStorId."'");
