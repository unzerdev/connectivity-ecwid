...
class Basket extends AbstractUnzerResource
{
    ...
    public function __construct(
        ...
        $this->setAmountTotalGross(number_format($amountTotalGross,2));
    ...
    {
        $this->amountTotalGross = round((float)$amountTotalGross,2);
        return $this;
    }
    ...
    {
        $this->totalValueGross = round((float)$totalValueGross,2);
        return $this;
    }
    ...
    {
        $this->amountTotalDiscount = round((float)$amountTotalDiscount,2);
    ...
    {
        $this->amountTotalVat = round((float)$amountTotalVat,2);
        return $this;
    }
