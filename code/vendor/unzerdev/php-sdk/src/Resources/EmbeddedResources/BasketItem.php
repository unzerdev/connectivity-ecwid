...
class BasketItem extends AbstractUnzerResource
{
    ...
    public function __construct(
        ...
        $this->setAmountNet(number_format($amountNet,2));
    ...
    {
        $this->amountDiscount = round((float)$amountDiscount,2);
        return $this;
    }
    ...
    {
        $this->amountGross = round((float)$amountGross,2);
        return $this;
    }
    ...
    {
        $this->amountDiscountPerUnitGross = round((float)$amountDiscountPerUnitGross,2);
        return $this;
    }
    ...
    {
        $this->amountPerUnitGross = round((float)$amountPerUnitGross,2);
        return $this;
    }
    ...
    {
        $this->amountPerUnit = round((float)$amountPerUnit,2);
        return $this;
    }
